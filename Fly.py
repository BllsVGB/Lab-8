...
def video_processing():
    ...
    while True:
        ...
        if found and found[0] > 0.6:
            ...
            cv2.putText(frame_resized, coordinates_text, (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 2)
        else:
            print("Метка не обнаружена")
            cv2.putText(frame_resized, "Метка не обнаружена", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 2)
